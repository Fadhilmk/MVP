...
const ImportPage = () => {
  ...
  const processNumbers = async (parsedData) => {
    const validNumbers = [];
    const numbersCollection = collection(db, "phoneNumbers");
    ...
    validNumbers.forEach(number => {
      const numberDoc = doc(db, "phoneNumbers", number.phone);
  ...
  const handleDelete = async () => {
    ...
    selectedNumbers.forEach(phone => {
      const numberDoc = doc(db, "phoneNumbers", phone);
  ...
  const handleAddContact = async () => {
    ...
    const numberDoc = doc(db, "phoneNumbers", newContact.phone);
